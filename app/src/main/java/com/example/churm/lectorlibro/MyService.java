...
public class MyService extends Service implements MediaPlayer.OnPreparedListener, MediaController.MediaPlayerControl {
    ...
    //    Declarar la clase myBinder extendiendo de Ibinder la cual nos dará la posibilidad de traer la instancia del servicio
    ...
    // Sobrescribir el método onBind() para retornar la instancia de la clase MiBinder declarada anteriormente
    @Override
